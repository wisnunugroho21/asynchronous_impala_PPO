...
class Learner():
    ...
    def save_list(self, states, actions, action_means, rewards, dones, next_states):
        self.memory.save_list(states, actions, action_means, rewards, dones, next_states)

    # Loss for PPO  
    def get_loss(self, action_mean, values, old_action_mean, old_values, next_values, actions, rewards, dones, worker_action_means):
    ...
    def training_ppo(self, states, actions, worker_action_means, rewards, dones, next_states):                 
        ...
        loss = self.get_loss(action_mean, values, old_action_mean, old_values, next_values, actions, rewards, dones, worker_action_means)
